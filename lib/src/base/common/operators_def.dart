...
const st$fill = r'$fill';
const st$geoNear = r'$geoNear';
const st$graphLookup = r'$graphLookup';
const st$group = r'$group';
const st$indexStats = r'$indexStats';
const st$limit = r'$limit';
const st$listLocalSessions = r'$listLocalSessions';
const st$listSampledQueries = r'$listSampledQueries';
const st$listSearchIndexes = r'$listSearchIndexes';
const st$listSessions = r'$listSessions';
const st$lookup = r'$lookup';
const st$match = r'$match';
const st$merge = r'$merge';
const st$out = r'$out';
const st$planCacheStats = r'$planCacheStats';
const st$project = r'$project';
const st$redact = r'$redact';
const st$replaceRoot = r'$replaceRoot';
const st$replaceWith = r'$replaceWith';
const st$sample = r'$sample';
const st$search = r'$search';
const st$searchMeta = r'$searchMeta';
const st$set = r'$set';
const st$setWindowFields = r'$setWindowFields';
const st$shardedDataDistribution = r'$shardedDataDistribution';
